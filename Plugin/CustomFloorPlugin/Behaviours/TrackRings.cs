...
public class TrackRings : MonoBehaviour, INotifyPlatformEnabled, INotifyPlatformDisabled
{
    ...
    public void PlatformEnabled(DiContainer container)
    {
        ...
        if (_trackLaneRingsManager == null)
        {
            ...
            var trackLaneRing = trackLaneRingPrefab.AddComponent<TrackLaneRing>();
            ...
            foreach (var notifyEnable in GetComponentsInChildren<INotifyPlatformEnabled>(true).Where(x => !ReferenceEquals(x, this)))
        ...
        if (useRotationEffect)
        {
            if (_trackLaneRingsRotationEffectSpawner == null)
            {
                ...
                _trackLaneRingsRotationEffectSpawner.SetField(nameof(_trackLaneRingsRotationEffectSpawner._beatmapCallbacksController), _beatmapCallbacksController);
                _trackLaneRingsRotationEffectSpawner.SetField(nameof(_trackLaneRingsRotationEffectSpawner._random), _random);
